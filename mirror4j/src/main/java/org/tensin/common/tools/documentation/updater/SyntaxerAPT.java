...
public class SyntaxerAPT implements ISyntaxer {
	...
	/* (non-Javadoc)
	 * @see org.tensin.common.tools.documentation.updater.ISyntaxer#buildHeader(int, java.lang.String, java.lang.String)
	 */
	@Override
	public String buildHeader(final int level, final String value,
	...
	/* (non-Javadoc)
	 * @see org.tensin.common.tools.documentation.updater.ISyntaxer#buildHTMLLink(java.lang.String, java.lang.String)
	 */
	@Override
