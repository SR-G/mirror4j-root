...
public class ClasspathBooter {
     ...
     *             Error
     */
    private static Method getAddUrlMethod() throws Mirror4JException {
     ...
     *             Error
     */
    public void addAllJars() throws Mirror4JException {
     ...
     *             Error
     */
    public void addAllJars(final String pathToLoad) throws Mirror4JException {
     ...
     *             Error
     */
    public void addJarsToClasspath(final List<String> expectedJars) throws Mirror4JException {
     ...
     *             Error
     */
    public void addJarsToClasspath(final Set<String> expectedJars) throws Mirror4JException {
     ...
     *             Error
     */
    public void addJarsToClasspath(final String lib, final List<String> expectedJars) throws Mirror4JException {
        if (!isEmpty(lib)) {
            if (new File(lib.replaceAll("file:", "")).isDirectory()) {
                final File dir = getLibraryPathFile(lib);
                final List<File> potentialJars = loadJarsInPath(dir);
                if ((potentialJars == null) || (potentialJars.size() == 0)) {
                    throw new Mirror4JException("No jars found in path [" + dir.getAbsolutePath() + "]");
                }
     ...
     *             Error
     */
    public void addJarsToClasspath(final String lib, final Set<String> expectedJars) throws Mirror4JException {
     ...
     *             Error
     */
    public void addJarsToClasspath(final String lib, final String[] expectedJars) throws Mirror4JException {
     ...
     *             Error
     */
    public void addJarsToClasspath(final String[] expectedJars) throws Mirror4JException {
        if ((expectedJars != null) && (expectedJars.length > 0)) {
            addJarsToClasspath(getLibraryPathName(jarBaseName), expectedJars);
        }
    }
     ...
     *             the core exception
     */
    public boolean addJarsToClasspathWithMagickDiscovery(final List<String> possibleJarNames, final List<String> possiblePaths) throws Mirror4JException {
	 ...
	 */
	public void addPlugins(Collection<String> plugins) throws Mirror4JException {
     ...
     *             Error
     */
    public void execute(final String className, final String methodName) throws Mirror4JException {
     ...
     *             Error
     */
    public void execute(final String className, final String methodName, final Class<?>[] argsDefinitions, final Object[] argsValues) throws Mirror4JException {
        Class<?> mainClass;
        try {
     ...
     *             Error
     */
    private File getLibraryPathFile(final String lib) throws Mirror4JException {
        File result = null;
        ...
        try {
            ...
            throw new Mirror4JException("URI " + libToAdd + " incorrecte", e);
        }
        return result;
    }
     ...
     *             Erreur
     */
    public List<File> getProvidedJarName(final String regExp) throws Mirror4JException {
     ...
     *             Error
     */
    private List<File> loadNeededJars(final File dir, final List<File> potentialJars, final List<String> neededJars) throws Mirror4JException {
        final List<File> result = new ArrayList<File>();
        ...
        if (errors > 0) {
            if (stopIfMissingJars) {
                throw new Mirror4JException("Some expected jars are missing in the path [" + dir.getAbsolutePath() + "] : \n" + displayMissingJars());
            }
        }
     ...
     *             Error
     */
    protected void updateCurrentClasspath(final List<File> neededJars) throws Mirror4JException {
        File jar = null;
        ...
        while (itr.hasNext()) {
            jar = itr.next();
            if (!jar.exists()) {
                throw new Mirror4JException("Expected jar not found [" + jar.getAbsolutePath() + "]");
            }
