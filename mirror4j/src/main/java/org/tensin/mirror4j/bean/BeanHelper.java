package org.tensin.mirror4j.bean;
...
import org.tensin.mirror4j.model.Mirror4JRuntimeException;
...
public final class BeanHelper {
    ...
    public static int compareTo(final Object obj1, final Object obj2) {
        ...
        for (final AccessibleObject ao : getAccessibleObjects(BeanField.class, obj1.getClass(), CONSTANT_FILTER_EQUALS)) {
            try {
                ...
                throw new Mirror4JRuntimeException(e);
            } catch (Mirror4JException e) {
                throw new Mirror4JRuntimeException(e);
            }
        }
     ...
     *             the core exception
     */
    public static Object copy(final Object source, final Object destination) throws Mirror4JException {
        if (source == null) {
     ...
     *             the core exception
     */
    public static Object invoke(final Field f, final Object object) throws Mirror4JException {
        try {
            return f.get(object);
        } catch (IllegalArgumentException e) {
     ...
     *             the core exception
     */
    public static Object invoke(final java.lang.reflect.Method m, final Object object) throws Mirror4JException {
        try {
